...
<body>
  ...
  <main class="pt-64 pb-10 mx-auto w-3/5" onclick="changeSizeOfInputs()"
    id="click">
    ...
    <?php } ?>
    <button class="bg-red-600 p-3 px-5 rounded-full text-white font-bold"
      onclick="checkAnswer()" id="checkButton">Подтвердить
      ответ</button>
